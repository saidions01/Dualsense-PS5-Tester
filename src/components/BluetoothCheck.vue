...
<template>
  <div class="dualsense-check">
    ...
    <h1 class="blinking-text">Connect your blutooth by pressing on the colored buttons </h1>
    <svg viewBox="0 0 1117 892">
      <path
        ...
        :class="{ 'ds-trigger-active': state.buttons.r2 }"
        :style="{
      ...
      <path
        ...
        class="ds-stroke-normal"
        :class="{ 'ds-trigger-active': state.buttons.l2 }"
        :style="{
      ...
      <g id="dpad-up">
        <path
          ...
          class="ds-stroke-normal"
          :class="{ 'ds-active': state.buttons.dPadUp }"
        />
        <path
      ...
      <g id="dpad-down">
        <path
          ...
          class="ds-stroke-normal"
          :class="{ 'ds-active': state.buttons.dPadDown }"
        />
        <path
      ...
      <g id="dpad-right">
        <path
          ...
          class="ds-stroke-normal"
          :class="{ 'ds-active': state.buttons.dPadRight }"
        />
        <path
      ...
      <g id="dpad-left">
        <path
          ...
          class="ds-stroke-normal"
          :class="{ 'ds-active': state.buttons.dPadLeft }"
        />
        <path
      ...
      <path
        ...
        class="ds-stroke-normal"
        :class="{ 'ds-active': state.buttons.mute }"
      />
      <path
        id="border3"
      ...
      <g id="touchpadgroup" ref="TouchpadGroupRef">
        <path
          ...
          class="ds-stroke-normal"
          :class="{ 'ds-touchpad-active': state.buttons.touchPadClick }"
        />
        <circle
          v-for="touch of state.touchpad.touches"
          :key="touch.touchId"
          r="19"
          class="ds-filled-icon"
        />
      ...
      <path
        ...
        class="ds-stroke-normal"
        :class="{ 'ds-active': state.buttons.r1 }"
      />
      <path
        id="l1"
        ...
        class="ds-stroke-normal"
        :class="{ 'ds-active': state.buttons.l1 }"
      />
      <path
        id="options"
        ...
        class="ds-stroke-normal"
        :class="{ 'ds-active': state.buttons.options }"
      />
      <path
        id="create"
        ...
        class="ds-stroke-normal"
        :class="{ 'ds-active': state.buttons.create }"
      />
      <g id="create-icon">
        <path
      ...
      <g id="r3group">
        ...
        <circle
          ...
          cy="528.548"
          r="57.193"
          class="ds-stroke-normal ds-stick"
          :class="{ 'ds-active': state.buttons.r3 }"
        />
      </g>
      <g id="l3group">
        <circle
        ...
        <circle
          ...
          r="57.193"
          class="ds-stroke-normal ds-stick"
          :class="{ 'ds-active': state.buttons.l3 }"
        />
      </g>
      <path
        id="ps"
        ...
        class="ds-ps-icon"
        :class="{ 'ds-active': state.buttons.playStation }"
      />
    </svg>
...
.dualsense-check {
  ...
  margin-left: 150px;
  padding: 5px; /* Reduced padding to make the container smaller */
  border-radius: 6px;
  width: 500px; /* Optionally set a specific width */
  height: 600px; /* Let the content define the height or set a specific value */
}
