...
let SvgElement=ref<SVGElement | null>(null)
...
// State to control message display
const showInitialazationMessage = ref(true)
const showProcessingMessage = ref(false)
const showNotOkMessage = ref(false)
...
const checkSticks = () => {
  const isStickMax = (value:number) => Math.abs(value) === 1

  

  // Check for left stick extremes
  if (state.value.axes.leftStickX === -1 && !leftXminReached) {
    leftStickOk.leftStickXmin = true
    leftXminReached = true
  }

  if (state.value.axes.leftStickX === 1 && !leftXmaxReached) {
    leftStickOk.leftStickXmax = true
    leftXmaxReached = true
  }

  if (state.value.axes.leftStickY === -1 && !leftYminReached) {
    leftStickOk.leftStickYmin = true
    leftYminReached = true
  }

  if (state.value.axes.leftStickY === 1 && !leftYmaxReached) {
    leftStickOk.leftStickYmax = true
    leftYmaxReached = true
  }

  // Check for right stick extremes
  if (state.value.axes.rightStickX === -1 && !rightXminReached) {
    rightStickOk.rightStickXmin = true
    rightXminReached = true
  }

  if (state.value.axes.rightStickX === 1 && !rightXmaxReached) {
    rightStickOk.rightStickXmax = true
    rightXmaxReached = true
  }

  if (state.value.axes.rightStickY === -1 && !rightYminReached) {
    rightStickOk.rightStickYmin = true
    rightYminReached = true
  }

  if (state.value.axes.rightStickY === 1 && !rightYmaxReached) {
...
// block to check the first test if any of the buttons is derived
// Function to check button states for 3 seconds


onMounted(() => {
 // checkButtonStates(3000)// Check for 3 seconds
})
...
watch(
  () => [leftStickOk.leftStickXmax, leftStickOk.leftStickXmin, 
  leftStickOk.leftStickYmax, leftStickOk.leftStickYmin,state.value.axes.gyroX, state.value.axes.gyroY, state.value.axes.gyroZ],
  () => {
      secondStepResult.value=Object.entries(testobject).every(([key, value]) => value)
      secondStepResult.value=Object.entries(testAxesObject).every(([key,value])=>value)
...
<template >
    ...
    <svg  viewBox="0 0 1117 892">
        <path id="r2"
            ...
            class="ds-stroke-normal" :class="{ 'ds-red':buttonClasses.r2 }" :style="{
        ...
        <path id="l2"
            ...
            class="ds-stroke-normal" :class="{ 'ds-red':buttonClasses.l2}" :style="{
        ...
        <g id="dpad-up">
            <path
                ...
                class="ds-stroke-normal" :class="{ 'ds-red':buttonClasses.dPadUp }" />
        ...
        <g id="dpad-down">
            <path
                ...
                class="ds-stroke-normal" :class="{ 'ds-red':buttonClasses.dPadDown  }" />
        ...
        <g id="dpad-right">
            <path
                ...
                class="ds-stroke-normal" :class="{ 'ds-red':buttonClasses.dPadRight}" />
        ...
        <g id="dpad-left">
            <path
                ...
                class="ds-stroke-normal" :class="{ 'ds-red':buttonClasses.dPadLeft }" />
        ...
        <path id="mute"
            ...
            class="ds-stroke-normal" :class="{'ds-red':buttonClasses.mute }" />
    ...
    <path id="touchpad"
          ...
          class="ds-stroke-normal"
          :class="{ 'ds-red':buttonClasses.touchPadClick }" />
        ...
        <path id="r1"
            ...
            class="ds-stroke-normal" :class="{ 'ds-red':buttonClasses.r1 }" />
        <path id="l1"
            ...
            class="ds-stroke-normal" :class="{ 'ds-red':buttonClasses.l1 }" />
        <path id="options"
            ...
            class="ds-stroke-normal" :class="{ 'ds-red':buttonClasses.options }" />
        <path id="create"
            ...
            class="ds-stroke-normal" :class="{ 'ds-red':buttonClasses.create }" />
        <g id="create-icon">
        ...
        <g id="r3group">
            ...
            :class="{'ds-red':axesClasses.rightStickX || axesClasses.rightStickY
            }" />
            <circle id="r3" cx="763.456" cy="528.548" r="57.193" class="ds-stroke-normal ds-stick"
                :class="{ 'ds-red':buttonClasses.r3 }" :style="{
        ...
        <g id="l3group">
            ...
            :class="{'ds-red':axesClasses.leftStickX || axesClasses.leftStickY}"/>
            <circle id="l3" cx="351.764" cy="528.548" r="57.193" class="ds-stroke-normal ds-stick"
                :class="{ 'ds-red':buttonClasses.l3 }" :style="{
        ...
        <path id="ps"
            ...
            class="ds-ps-icon" :class="{ 'ds-red':buttonClasses.playStation }" />
    </svg>
