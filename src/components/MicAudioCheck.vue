...
watch(
  () => state.value.headphoneConnected,
  () => {
    performCheck()
  }
)
// Watcher for triangle button presse
watch(
...
.blinking-text {
  font-weight: 700;
  animation: blink-animation-08df3c6d 2s steps(5, start) infinite;
  color: #6495ed;
  font-size: 16px;
  text-align: center;
  padding: 10px;
